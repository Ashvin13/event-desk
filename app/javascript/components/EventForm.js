...
class EventForm extends React.Component {
  ...
  render() {
    ...
    if (!event.id && path === '/events/:id/event') return <EventNotFound />;
        ...
        <form className="eventForm" onSubmit={this.handleSubmit}>
          ...
          <div>
            <label htmlFor="event_date">
              <strong>Date:</strong>
              <input type="text" id="event_date" name="event_date" ref={this.dateInput} onChange={this.handleInputChange} autoComplete="off" value={event.event_date} />
            </label>
          </div>
          <div>
            <label htmlFor="title">
